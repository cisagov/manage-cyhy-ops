...
issue](https://github.com/cisagov/manage-cyhy-ops/issues) in
...
request](https://github.com/cisagov/manage-cyhy-ops/pulls),
...
```console
cd manage-cyhy-ops
pyenv virtualenv <python_version_to_use> manage-cyhy-ops
pyenv local manage-cyhy-ops
