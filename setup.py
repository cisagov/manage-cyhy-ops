...
setup(
    ...
    version=get_version("src/manage_cyhy_ops/_version.py"),
    ...
    project_urls={
        "Source": "https://github.com/cisagov/manage-cyhy-ops",
        "Tracker": "https://github.com/cisagov/manage-cyhy-ops/issues",
    },
    # Author details
    ...
    install_requires=["boto3", "botocore", "docopt", "schema", "setuptools >= 24.2.0"],
    extras_require={
        "test": [
            "coverage",
